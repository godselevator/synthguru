using AOS.DataAccessLayer.Contact82;
using AOS.DataAccessLayer.Find82;
using AOS.DataAccessLayer.Preference82;
using AOS.DataAccessLayer.SoPrincipal82;
using AOS.DataAccessLayer.User82;
...
{
    public class AOSServiceLayer82 : IAOSServiceLayer
    {
        ...
        // Constructor 1
        public AOSServiceLayer82(string endpoint)
        {
            Endpoint = endpoint;
        }

        // Constructor 2
        public AOSServiceLayer82(string endpoint, bool httpsEnabled)
        {
            Endpoint = endpoint;
        ...
        public TestServiceConnectionResponse TestConnection(string url, string userName, string password)
        {
            ...
            SoPrincipal82.SoTimeZone tzone;
            SoPrincipal82.SoSystemInfoCarrier response;
            SoPrincipal82.SoExtraInfo extraInfo;

            // Service Endpoint
            var bindingName = (HttpsEnabled) ? "BasicHttpBinding_SoPrincipal82SSL" : "BasicHttpBinding_SoPrincipal82";
            SoPrincipal82.SoPrincipalClient client = new SoPrincipal82.SoPrincipalClient(bindingName);
            ...
            if (credentials.AuthenticationSucceeded)
            {
                ...
                if (success)
                {
                    ...
                    resp.Ticket = credentials.Credentials82.Ticket;
                }
            }
            else
            {
        ...
        public IAOSCredentials SOGetCredentials(string userName, string password)
        {
            ...
            try
            {
                ...
                SoPrincipal82.SoPrincipalClient credClient = new SoPrincipal82.SoPrincipalClient(bindingName);
                SoPrincipal82.SoPrincipalCarrier responseCarrier = null;
                SoPrincipal82.SoCredentials credentials = null;
                SoPrincipal82.SoTimeZone timezone = null;
                SoPrincipal82.SoExtraInfo extraInfo = null;
                ...
                var returnVal = new AOSCred82()
                {
                    AuthenticationSucceeded = authenticationSuceeded,
                    Success = success,
                    ErrorMsg = "Ok",
                    Credentials82 = credentials,
                    ResponseCarrier82 = responseCarrier,
                    TimeZone82 = timezone
                };
            ...
            catch (Exception ex)
            {
                ...
                return new AOSCred82()
                {
                    AuthenticationSucceeded = false,
                    Success = false,
                    ErrorMsg = msg,
                    Credentials82 = null,
                    ResponseCarrier82 = null,
                    TimeZone82 = null
                };
            }
        }
        ...
        public List<AOS.DomainModel.Contact> SOGetAllContacts(IAOSCredentials credentials)
        {
            ...
            // Service header
            Find82.FindResults findList = null;

            Find82.SoTimeZone tzone = new Find82.SoTimeZone();
            var bindingName = (HttpsEnabled) ? "BasicHttpBinding_Find82SSL" : "BasicHttpBinding_Find82";

            Find82.FindClient findClient = new FindClient(bindingName);
            Find82.SoCredentials cred = new Find82.SoCredentials();
            Find82.SoExtraInfo extraInfo = new Find82.SoExtraInfo();
            ...
            // Restrictions
            Find82.ArchiveRestrictionInfo[] restrictions;
            List<Find82.ArchiveRestrictionInfo> listRestrictions = new List<Find82.ArchiveRestrictionInfo>();

            listRestrictions.Add(new Find82.ArchiveRestrictionInfo()
            {
                Name = "getAllRows",
                Operator = "set",
            ...
            Find82.ArchiveOrderByInfo[] orderby = new Find82.ArchiveOrderByInfo[1];
            orderby[0] = new Find82.ArchiveOrderByInfo();
            orderby[0].Direction = Find82.OrderBySortType.ASC;
            orderby[0].Name = "contactId";

            cred.ExtensionData = (credentials.TimeZone82 == null) ? null : credentials.TimeZone82.ExtensionData;
            cred.Ticket = credentials.Credentials82.Ticket;

            if (credentials.TimeZone82 != null)
            {
                tzone.ExtensionData = (credentials.TimeZone82 == null) ? null : credentials.TimeZone82.ExtensionData;
                tzone.SoTimeZoneId = (credentials.TimeZone82 == null) ? 0 : credentials.TimeZone82.SoTimeZoneId;
                tzone.SoTimeZoneLocationCode = (credentials.TimeZone82 == null) ? null : credentials.TimeZone82.SoTimeZoneLocationCode;
            }
        ...
        {
            Archive82.ArchiveListItem[] response = null;
            Archive82.SoTimeZone tzone = new Archive82.SoTimeZone();
            var bindingName = (HttpsEnabled) ? "BasicHttpBinding_Archive82SSL" : "BasicHttpBinding_Archive82";
            Archive82.ArchiveClient archiveClient = new Archive82.ArchiveClient(bindingName);
            Archive82.SoCredentials cred = new Archive82.SoCredentials();
            Archive82.SoExtraInfo extraInfo = new Archive82.SoExtraInfo();
            ...
            // Restrictions
            Archive82.ArchiveRestrictionInfo[] restrictions = new Archive82.ArchiveRestrictionInfo[1];
            restrictions[0] = new Archive82.ArchiveRestrictionInfo();
            ...
            Archive82.ArchiveOrderByInfo[] orderby = new Archive82.ArchiveOrderByInfo[1];
            orderby[0] = new Archive82.ArchiveOrderByInfo();
            orderby[0].Direction = Archive82.OrderBySortType.DESC;
            ...
            if (credentials.AuthenticationSucceeded)
            {
                cred.ExtensionData = credentials.Credentials82.ExtensionData;
                cred.Ticket = credentials.Credentials82.Ticket;

                if (credentials.TimeZone82 != null)
                {
                    tzone.ExtensionData = credentials.TimeZone82.ExtensionData;
                    tzone.SoTimeZoneId = credentials.TimeZone82.SoTimeZoneId;
                    tzone.SoTimeZoneLocationCode = credentials.TimeZone82.SoTimeZoneLocationCode;
                }
        ...
        public User SOGetUserByPersonId(IAOSCredentials credentials, int personId)
        {
            ...
            var bindingName = (HttpsEnabled) ? "BasicHttpBinding_User82SSL" : "BasicHttpBinding_User82";
            User1Client uClient = new User1Client(bindingName);

            User[] response = null;
            User currentUser = null;
            User82.SoTimeZone tzone = new User82.SoTimeZone();
            User82.SoCredentials cred = new User82.SoCredentials();
            User82.SoExtraInfo extraInfo = new User82.SoExtraInfo();

            uClient.Endpoint.Address = new System.ServiceModel.EndpointAddress(Endpoint + "/User.svc");

            cred.ExtensionData = (credentials.Credentials82.ExtensionData == null) ? null : credentials.Credentials82.ExtensionData;
            cred.Ticket = credentials.Credentials82.Ticket;

            if (credentials.TimeZone82 != null)
            {
                tzone.ExtensionData = (credentials.TimeZone82.ExtensionData == null) ? null : credentials.TimeZone82.ExtensionData;
                tzone.SoTimeZoneId = credentials.TimeZone82.SoTimeZoneId;
                tzone.SoTimeZoneLocationCode = (credentials.TimeZone82.SoTimeZoneLocationCode == null) ? null : credentials.TimeZone82.SoTimeZoneLocationCode;
            }
        ...
        public int GetPreferenceBySectionAndKey(IAOSCredentials credentials, string section, string key)
        {
            ...
            var bindingName = (HttpsEnabled) ? "BasicHttpBinding_Preference82SSL" : "BasicHttpBinding_Preference82";

            // Setup properties prior to webservice call
            Preference82.SoTimeZone tzone = new Preference82.SoTimeZone();
            Preference82.Preference1Client client = new Preference82.Preference1Client(bindingName);
            client.Endpoint.Address = new System.ServiceModel.EndpointAddress(Endpoint + "/Preference.svc");
            Preference82.SoExtraInfo extraInfo = new Preference82.SoExtraInfo();
            Preference82.SoCredentials cred = new Preference82.SoCredentials();
            cred.Ticket = credentials.Credentials82.Ticket;

            if (credentials.TimeZone82 != null)
            {
                credentials.Credentials82.ExtensionData = (credentials.TimeZone82.ExtensionData == null) ? null : credentials.TimeZone82.ExtensionData;
                tzone.ExtensionData = (credentials.TimeZone82.ExtensionData == null) ? null : credentials.TimeZone82.ExtensionData;
                tzone.SoTimeZoneId = credentials.TimeZone82.SoTimeZoneId;
                tzone.SoTimeZoneLocationCode = (credentials.TimeZone82.SoTimeZoneLocationCode == null) ? null : credentials.TimeZone82.SoTimeZoneLocationCode;
            };
            ...
            bool success = false;
            Preference82.Preference[] response = null;
        ...
        public bool GetPrefDescById(IAOSCredentials credentials, int prefDescId)
        {
            ...
            // Define succes and response variables
            bool success = false;
            Preference82.PreferenceDescription response = null;
        ...
        public int SOSaveContact(IAOSCredentials credentials, string name)
        {
            ...
            // Setup bindingname depending on http/https
            var bindingName = (HttpsEnabled) ? "BasicHttpBinding_Contact82SSL" : "BasicHttpBinding_Contact82";

            // Setup properties prior to webservice call
            Contact82.SoTimeZone tzone = new Contact82.SoTimeZone();
            Contact82.Contact1Client client = new Contact82.Contact1Client(bindingName);
            client.Endpoint.Address = new System.ServiceModel.EndpointAddress(Endpoint + "/Contact.svc");
            Contact82.SoExtraInfo extraInfo = new Contact82.SoExtraInfo();
            Contact82.SoCredentials cred = new Contact82.SoCredentials();
            cred.Ticket = credentials.Credentials82.Ticket;
